...
function Technologies() {
    return <div className="mt-24 md:mt-40" id="technologies">
        ...
        <div className="grid grid-cols-3 px-16 items-end md:grid-cols-4 md:mx-16 lg:mx-48 xl:mx-80">
            ...
            <img className=" w-24 technologies-img md:w-28" src="/pics/redux.png" alt="redux" />
            ...
            <img className=" w-16 technologies-img md:w-20 pb-2" src="/pics/bootstrap.svg" alt="Bootstrap" />
            <img className=" w-20 technologies-img md:w-24" src="/pics/sass2.svg" alt="Sass" />
            <img className=" w-20 technologies-img md:w-24" src="/pics/git.svg" alt="Git" />    
