...
function Technologies() {
    return <section className="mt-24 md:mt-40" id="technologies">
        ...
        <section className="grid grid-cols-3 px-16 items-end md:grid-cols-4 md:mx-16 lg:mx-48 xl:mx-80">
            ...
            <img className=" w-24 technologies-img md:w-28" src="/pics/redux.png" alt="Redux-img" />
            ...
            <img className=" w-20 technologies-img md:w-28" src="/pics/sass2.svg" alt="Sass-img" />
            <img className=" w-20 technologies-img md:w-28" src="/pics/node.svg" alt="Node-img" />
            <img className=" w-20 technologies-img md:w-24" src="/pics/express.svg" alt="Express-img" />
            <img className=" w-20 technologies-img md:w-32" src="/pics/mongodb.svg" alt="MongoDB-img" />
